...
install_3proxy() {
    echo "Installing 3proxy service..."
    mkdir -p /3proxy
    cd /3proxy
    ...
    wget https://raw.githubusercontent.com/xuanquy1188/create-proxy/main/3proxy.service --output-document=/3proxy/3proxy-0.9.3/scripts/3proxy.service2
